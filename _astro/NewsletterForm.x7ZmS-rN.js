import{j as t}from"./jsx-runtime.D_zvdyIk.js";import{r as d}from"./index.DBy5LfQW.js";import{s as a,O as c}from"./engine.CUwE93Op.js";function x({thankYouHref:n}){const[o,l]=d.useState(!1);function r(s){s.preventDefault();const m=s.target,e=new FormData(m).get("email"),i=typeof window<"u"?window.location.pathname:"";a({toEmail:c,replyTo:e||void 0,subject:`New blog-newsletter lead: ${e||"website visitor"}`,bodyText:`New submission from the blog-newsletter form:
