...
export const articles: Article[] = [
  ...
  },
  {
    ...
    title: "Why does my competitor outrank me on Google Maps when I'm closer?",
    excerpt: "Distance is only 1 of the 3 factors Google uses to rank local results, which is why a business further away routinely appears above one on the same street.",
    author: "Click.n.likes team",
    readTime: "9 min read",
    date: "2026-08-14",
    body: `<p>In the past, a business on the busiest street in town held an advantage no competitor could argue with. Proximity was destiny: the customer walked past your door, and the shop two streets away never entered the consideration set at all. The map has replaced the street, and it does not honour that arrangement. A business two kilometres further from the searcher routinely appears above one that is closer, and the owner of the closer business is left looking at a result that seems to break the only rule they thought the system had.</p>
      <p>This is among the most common questions clinic owners, restaurateurs, contractors and showroom managers bring to us, and it usually arrives with an edge of genuine disbelief. The answer is not that Google has malfunctioned, and it is not that the competitor has quietly paid for the position. It is that distance was never the whole ranking system. It is one third of it, and it happens to be the third you cannot change.</p>
      <h2>Why isn't the closest business always the top result on Google Maps?</h2>
      <p>Because Google ranks local results on three separate factors, and proximity is only one of them. <a href="https://support.google.com/business/answer/7091" target="_blank" rel="noopener">Google's own Business Profile documentation</a> names them plainly:</p>
      <ul>
        <li><strong>Relevance:</strong> How well your profile matches what the person actually searched. A profile that names the specific treatment, product or service in its categories and description is a better match than one describing the business in general terms, even if both businesses genuinely offer it.</li>
        <li><strong>Distance:</strong> How far each result sits from the searcher, or from the location named in the search. This is the factor everybody knows about and the only one nobody can influence.</li>
        <li><strong>Prominence:</strong> How well known the business is, drawn from reviews, links, citations across the web, and its wider real-world profile.</li>
      </ul>
      <p>Google is explicit that these work together, and that a more prominent, more relevant result can appear above a nearer one. Read that carefully and the frustrating result stops being a glitch: it is the system working exactly as documented, on two axes you had not been competing on.</p>
      <h2>What exactly is prominence, and why does it beat proximity so often?</h2>
      <p>Prominence is Google's estimate of how well known and well regarded a business is, and it beats proximity whenever the gap in it is wide enough to matter. A contractor five kilometres away with 180 reviews, a complete profile, consistent contact details across dozens of directories, and links from local press has given Google a great deal of evidence that it is a real, established, frequently-chosen business. A closer competitor with 14 reviews and a profile last touched three years ago has given it almost none.</p>
      <p>The important consequence for a business owner is that prominence is the factor most open to deliberate work. Reviews accumulate when someone asks for them systematically rather than hoping; citations become consistent when someone audits them; links arrive when a business is genuinely useful to its local community and says so publicly. None of that is fast, and none of it is a trick, which is precisely why it holds once it is built. If you have never run a structured review process, <a href="/insights/reviews-that-convert/">how to get more Google reviews without begging for them</a> is the more useful starting point than anything on this page.</p>
      <h2>Why does a competitor with fewer reviews sometimes still outrank me?</h2>
      <p>Because they have beaten you on relevance rather than prominence, and relevance is usually the cheaper gap to close. Review count is the signal owners watch, so it is the one they assume decides everything. In practice a profile that has selected the precise primary category, listed each service as its own entry, written a description in the language buyers actually use, and kept hours, photos and attributes current will out-match a profile with more reviews and a vaguer identity.</p>
      <p>This is the single most common diagnosis we reach when a business is convinced the map is behaving irrationally. The competitor is not more popular. They are more specifically described, and the search was specific. Most of the profile-level errors behind this are unglamorous and entirely fixable, and we have catalogued them in <a href="/insights/gbp-mistakes/">the Google Business Profile mistakes costing you the local pack</a>.</p>
      <h2>How far can prominence actually carry a business?</h2>
      <p>Not indefinitely, and any agency promising otherwise is selling you something. Proximity remains a powerful constraint: a strong, well-reviewed business will not appear for a "near me" search conducted twenty kilometres away, because at that distance no amount of prominence makes it a sensible answer to the question. What prominence realistically buys is the ability to win inside your genuine catchment, against businesses that happen to sit a little closer to a given searcher than you do.</p>
      <p>There is also a measurement trap worth naming, because it distorts more of these conversations than any ranking factor does. <strong>The map you are looking at is not the map your customers see.</strong> You are almost certainly checking from your own premises, which places you at the centre of the search and flatters your position, or from home, which does the same for wherever you live. Rankings on Google Maps vary continuously by the searcher's exact location, so a business can rank first from its own doorstep and fourth from a suburb three kilometres away where most of its customers actually live. Before concluding that you are losing, establish where your buyers are searching from, and check from there.</p>
      <p><strong>Example in Action:</strong> A multi-location clinic came to us certain that Maps was broken, because a competitor several kilometres away consistently appeared above them for their main treatment. The distance was real and unarguable. The rest was not: the competitor listed that treatment as a distinct service with its own category and had steady recent reviews naming the procedure directly, while the clinic sat under one generic category, with a description written for a brochure rather than a search box, and no review had mentioned the treatment by name in over a year. Nothing about the distance changed. The relevance gap was the whole story, and it was the part entirely within their control.</p>
      <h2>What should you actually fix first?</h2>
      <p>Work in the order of what is cheapest to change and hardest for a competitor to copy, which happens to be the reverse of where most owners start.</p>
      <ul>
        <li><strong>Fix relevance first:</strong> Primary category, individual service entries, and a description written in the words buyers type. This costs an afternoon and is the most common reason a nearer business loses.</li>
        <li><strong>Then fix consistency:</strong> Identical business name, address and phone number everywhere they appear online. Conflicting details actively undermine the confidence Google has in the listing.</li>
        <li><strong>Then build prominence deliberately:</strong> A standing process for requesting reviews, and genuine local links and mentions. This is slow, compounding, and the part competitors cannot shortcut.</li>
        <li><strong>Only then look at the website behind the listing:</strong> The listing points somewhere, and a slow or thin page undermines the enquiry the map just earned you.</li>
      </ul>
      <p>If your business serves customers at their location rather than at yours, the rules shift again in ways that catch a lot of owners out, and it is worth reading <a href="/insights/service-area-vs-storefront/">whether local SEO works differently for a service-area business</a> before you change anything on the profile.</p>
    ...
    faqs: [
      ...
      { q: "Why does a business with fewer reviews outrank me on Google Maps?", a: "Usually because it has beaten you on relevance rather than prominence. A profile with a precise primary category, individual service listings and a description using the words buyers actually search will out-match a vaguer profile that has more reviews." },
      { q: "Can I outrank a closer competitor on Google Maps?", a: "Within your genuine catchment, yes, by building relevance and prominence. Beyond it, no. Proximity still constrains results, so a business will not appear for a 'near me' search conducted far outside the area it realistically serves." },
      { q: "Why do my Google Maps rankings look different from my customer's?", a: "Because local results vary by the searcher's exact location. Checking from your own premises places you at the centre of the search and flatters your position, so you should check from where your customers actually search instead." },
      { q: "How long does it take to improve Google Maps rankings?", a: "Relevance fixes to categories, services and descriptions can be made in an afternoon and are often the fastest wins. Prominence, built from reviews, citations and local links, compounds slowly over months, which is also why it holds once established." },
    ],
  },
  {
    slug: "website-redesign-worth-it",
    tag: "Websites",
    categories: ["Websites & Conversion"],
    title: "Is a website redesign worth it, or should I just fix what I have?",
    excerpt: "A redesign is worth it when the foundation is wrong, not when the site merely looks dated, and confusing the 2 is how businesses spend heavily and gain nothing.",
    author: "Click.n.likes team",
    readTime: "9 min read",
    date: "2026-08-14",
    body: `<p>In the past, a business refreshed its premises on a rhythm dictated by wear: the paint faded, the signage aged, and at some point the whole frontage was redone because it plainly needed to be. A website invites the same instinct and rewards it far less reliably. Sites do not visibly weather, and the ones that look tired are frequently not the ones costing you money. Meanwhile a site that photographs beautifully can be quietly failing at the only job it has.</p>
      <p>So the question founders and marketing leads actually need answered is not whether their website looks current. It is whether the thing holding back enquiries is the surface or the foundation, because those two diagnoses lead to completely different invoices and completely different outcomes. Getting this wrong in either direction is expensive: a full rebuild that solves a problem a week of fixes would have solved, or a year of patches on a structure that was never going to work.</p>
      <h2>When is fixing the existing site genuinely the right call?</h2>
      <p>When the structure underneath is sound and the problems are identifiable, specific and local to particular pages. If your site is technically healthy, the pages you need already exist, and search traffic is steady rather than declining, then you are looking at a maintenance job rather than a rebuild. Slow pages can be made fast, weak copy can be rewritten, and a poor enquiry form can be replaced, all without touching the foundation.</p>
      <p>This is the cheaper path and, when it applies, decisively the better one. A great deal of what businesses attribute to "the site looking old" turns out on inspection to be a handful of specific, fixable leaks, and load speed is the one that most often masquerades as a design problem. If enquiries have fallen without an obvious cause, establish <a href="/insights/slow-speed-costing-leads/">whether your slow load speed is actually costing you leads</a> before you conclude the design is at fault, because that particular fix rarely requires a rebuild.</p>
      <h2>When does a redesign actually become the cheaper option?</h2>
      <p>When fixing what exists costs more than replacing it, which happens more often than owners expect. The threshold is structural rather than aesthetic, and there are a few honest signals that you have crossed it:</p>
      <ul>
        <li><strong>The site fights every change:</strong> Each small edit requires a developer, breaks something else, or is impossible without touching code. A site you cannot maintain is a permanent tax, and no amount of patching removes it.</li>
        <li><strong>The structure does not match the business:</strong> The services you actually sell have no pages of their own, or are buried three levels down, because the site was built around an older version of the business. Navigation cannot fix a missing page.</li>
        <li><strong>It was never built to be found:</strong> No sensible URL structure, no per-page titles, no meaningful headings. These are foundational, and retrofitting them across a badly built site is frequently more work than rebuilding on a clean one.</li>
        <li><strong>It fails on a phone:</strong> Not merely cramped, but genuinely unusable, with overflowing layouts or forms that cannot be completed. Most of your buyers are on a phone, and a desktop-first site is a structural fault rather than a cosmetic one.</li>
        <li><strong>You are accumulating patches:</strong> If the site is a sequence of quick fixes layered on each other and still does not convert, further fixes are unlikely to be what changes that.</li>
      </ul>
      <p>Notice that "it looks dated" appears nowhere on that list. Dated design is a real problem, but it is a symptom worth weighing rather than a diagnosis on its own, and it is by some distance the most expensive reason to rebuild.</p>
      <h2>What does a redesign put at risk that a fix does not?</h2>
      <p>Your existing search rankings, and this is the part that goes unmentioned in most redesign conversations until it is too late. A rebuild that changes URLs without properly mapping the old ones to the new ones can discard search visibility that took years to earn. <a href="https://developers.google.com/search/docs/crawling-indexing/site-move-with-url-changes" target="_blank" rel="noopener">Google's own guidance on site moves with URL changes</a> is unambiguous that redirects must be set up deliberately, and that skipping this step is what causes traffic to collapse after a launch.</p>
      <p>We have seen businesses conclude that their new website "killed their leads" when what actually happened was that two hundred indexed pages were quietly replaced with dead ends. Any redesign quote worth accepting includes URL mapping and redirects as an explicit line item, and any agency that treats it as an afterthought is telling you something useful about how the project will go. This is exactly where redesign work and <a href="/services/seo/">SEO services</a> stop being separate disciplines.</p>
      <h2>How do you tell the difference before committing the money?</h2>
      <p>Diagnose against outcomes rather than appearance, and do it before anyone quotes you. Three questions settle most cases: Do the pages your buyers need actually exist? Can the site be changed without a developer? Is search traffic stable or in structural decline? A site that fails one of those is usually a fix. A site that fails two or three is usually a rebuild, and the rebuild will be cheaper than the eighteen months of patching that would otherwise precede it.</p>
      <p><strong>Example in Action:</strong> On our <a href="/work/aidbylaw/">13-month AidByLaw engagement</a>, the existing site was a generic template with duplicated meta titles, four flat navigation links, no homepage lead capture and no section addressing a significant audience segment. That was structural rather than cosmetic, so the decision was a rebuild rather than a refresh. Every page was redesigned and re-optimised, its metas and copy rewritten around real search queries, and an organic channel that had not previously existed was contributing roughly 40 leads a month by the close of the engagement. The redesign was worth it there precisely because the foundation, not the finish, was what had been wrong.</p>
      <h2>What should a redesign cost, and what should it include?</h2>
      <p>Enough to cover structure, search and conversion, not merely a new coat of paint. The failure mode is a quote priced as visual work that quietly excludes the things determining whether the site earns anything: URL mapping and redirects, per-page titles and descriptions written around real queries, a genuine mobile build, working lead capture, and page speed. We publish our full pricing openly rather than quoting case by case, and we have written up <a href="/insights/website-cost-checklist/">what a website should cost and what should be included</a> so a quote can be checked against something concrete before it is signed.</p>
      <p>Beware the quote that comes in far below everything else, too. It is nearly always cheaper because it has removed the parts that make a site work, which is a different purchase to the one you thought you were making, and we have set out exactly which items tend to go missing in <a href="/insights/cheap-website-cost/">why a good website costs more than the cheap quote</a>.</p>
    ...
    faqs: [
      ...
      { q: "Will a website redesign hurt my Google rankings?", a: "It can, if URLs change without redirects mapping the old pages to the new ones. Google's guidance on site moves with URL changes is explicit that this must be set up deliberately, and skipping it is the most common reason traffic collapses after a relaunch." },
      { q: "Is it cheaper to fix my website or rebuild it?", a: "Fixing is cheaper when the foundation is sound and the problems are specific and local to certain pages. Rebuilding becomes cheaper once the site fights every change, lacks the pages the business actually needs, or has accumulated patches without converting any better." },
      { q: "What should be included in a website redesign quote?", a: "Structure, search and conversion, not just visual design. Look explicitly for URL mapping and redirects, per-page titles and descriptions written around real queries, a genuine mobile build, working lead capture and page speed. Quotes that come in far below others usually exclude these." },
      { q: "How do I know if my slow website is the real problem?", a: "Test it before assuming the design is at fault. Load speed frequently masquerades as a design complaint, and it is fixable without a rebuild, so it is worth ruling out first when enquiries fall with no obvious cause." },
    ],
  },
  {
    slug: "ai-overview-traffic",
    tag: "AI Search",
    categories: ["AI Search"],
    title: "Are Google's AI Overviews stealing my website traffic?",
    excerpt: "For some businesses yes, measurably, and for others barely at all, and which group you are in depends entirely on the kind of searches that bring you customers.",
    author: "Click.n.likes team",
    readTime: "9 min read",
    date: "2026-08-14",
    body: `<p>In the past, the bargain between a search engine and a website was straightforward and mutually understood. Google answered the question by pointing at the pages that answered it, the searcher clicked through, and the business that had done the work of publishing something useful received the visitor. AI Overviews have altered that bargain: for a growing share of searches, the answer now appears at the top of the results page, assembled from those same sources, and the click that used to follow no longer necessarily does.</p>
      <p>The reaction in most businesses has been somewhere between anxiety and fatalism, encouraged by a great deal of coverage announcing the end of organic search altogether. That framing is wrong, and acting on it is expensive. The accurate answer is narrower and considerably more useful: AI Overviews have taken real traffic from some businesses, have barely touched others, and which group you belong to is largely predictable from the kind of searches that bring you customers.</p>
      <h2>Has organic traffic genuinely fallen because of AI Overviews?</h2>
      <p>For informational searches, yes, and the effect is measurable rather than anecdotal. Analysis by <a href="https://www.forbes.com/sites/terdawn-deboe/2026/05/18/google-ai-overviews-are-eating-your-website-traffic-fight-back/" target="_blank" rel="noopener">Sistrix, reported by Forbes</a>, found that ranking first on a results page typically earns a click around 27% of the time, but that when an AI Overview appears above it, the same first position earns roughly 11%. The page has not fallen in the rankings; the rankings have simply become worth less on those particular searches.</p>
      <p>That is a genuine change and it deserves to be taken seriously. It is also specific. The searches most affected are broad informational ones, the "what does X cost", "how does Y work", "do I need Z" questions that a paragraph can satisfy completely. If a searcher's need is fully met by three sentences, an AI Overview meets it and the visit no longer happens.</p>
      <h2>Which businesses are actually losing traffic, and which are not?</h2>
      <p>The businesses being hit hardest are the ones whose traffic came from answering general questions, and the ones barely affected are the ones whose customers search with intent to act.</p>
      <ul>
        <li><strong>Heavily affected:</strong> Consultancies, publishers, training providers and any business whose organic traffic was built on broad explanatory content. These are precisely the queries an AI Overview resolves in full.</li>
        <li><strong>Largely unaffected so far:</strong> Local and service businesses whose customers arrive through location-based searches. Someone looking for a dentist nearby, an emergency plumber or a supplier in their city is not looking for an explanation, and a summary paragraph does not substitute for a business to contact.</li>
        <li><strong>Mixed:</strong> Businesses selling considered, high-value products or services, where early research questions are absorbed by AI Overviews but the later comparison and shortlisting searches still produce clicks, because those decisions are not made from a summary.</li>
      </ul>
      <p>This distinction matters more than any headline percentage, because it determines whether you are facing a genuine structural problem or reading someone else's. A manufacturer, clinic or contractor whose enquiries come from location-based and product-specific searches is very likely watching an industry panic that has not reached them, and rebuilding a content strategy in response to it would be solving a problem they do not have.</p>
      <h2>What actually changes about how content should be written?</h2>
      <p>Content built to be the answer keeps working; content built to be the first paragraph of an answer does not. If your traffic came from posts explaining a concept in general terms, that traffic is genuinely at risk, because the explanation itself is now delivered on the results page. What survives is content that a summary cannot replace: specific pricing, real methodology, sourced figures, comparisons made with a point of view, and the details of how a decision is actually made in your category.</p>
      <p>There is also a shift in what a "result" means. Being cited inside an AI Overview places your business in front of the searcher even when no click follows, which is worth having and is earned in a fairly specific way. We have set out that mechanism in full in <a href="/insights/blog-that-ranks/">how to write one blog post that ranks and gets cited by AI</a>, and the same structural habits, direct answers to real questions, clear headings and genuinely checkable sourcing, serve both purposes at once.</p>
      <p><strong>Example in Action:</strong> The pattern we see most consistently across audits is that a business's thinnest, most general posts, the ones written to cover a topic broadly, lose impressions and clicks together, while its most specific pages, the ones naming a price, a process or a precise comparison, hold steady or grow. The lesson is not that blogging stopped working. It is that content which was only ever a summary now competes directly with a summary generated on the page above it, and loses.</p>
      <h2>Should businesses now optimise for AI assistants instead of Google?</h2>
      <p>Not instead of, and framing it as a replacement leads to bad decisions. The same page, structured well and genuinely useful, is what earns a conventional ranking, a citation in an AI Overview, and a mention when someone asks an assistant directly. These are not three separate disciplines requiring three separate budgets, whatever the current volume of marketing material suggests.</p>
      <p>What has changed is that being absent from those answers is now a distinct commercial risk rather than a theoretical one, particularly for businesses whose buyers have started their research inside an assistant rather than a search box. That is the shift we examine for a specific vertical in <a href="/insights/ai-search/">why your clinic needs to worry about ChatGPT, not just Google</a>, and it is the work our <a href="/services/ai-seo/">AI SEO services</a> exist to do.</p>
      <h2>What is the honest thing to do about it right now?</h2>
      <p>Measure before you react, because most businesses are working from a headline rather than their own data. Open Search Console and compare impressions against clicks over the last year. A drop in clicks while impressions hold steady is the signature of answers being absorbed above you. A drop in both is an ordinary ranking problem, not an AI one, and the fixes are entirely different. Doing this once will tell you more about your position than any industry statistic, including the ones quoted here.</p>
      <p>Then respond in proportion. If your traffic is genuinely informational, shift investment toward content a summary cannot replace and toward channels you own outright. If your customers arrive through local and product-specific searches, the far more likely truth is that your fundamentals still matter more than your AI strategy does.</p>
    ...
    faqs: [
      ...
      { q: "Which businesses are most affected by AI Overviews?", a: "Those whose traffic came from broad informational content, such as consultancies, publishers and training providers, because those questions are fully answered on the results page. Local and service businesses reached through location-based searches have been far less affected so far." },
      { q: "How can I tell if AI Overviews are costing me traffic?", a: "Compare impressions against clicks in Search Console over the past year. Clicks falling while impressions hold steady suggests answers are being absorbed above your result. Both falling together is an ordinary ranking problem with entirely different fixes." },
      { q: "Should I stop blogging because of AI Overviews?", a: "No, but general explanatory posts are genuinely at risk. Content that holds its value is content a summary cannot replace: specific pricing, real methodology, sourced figures and comparisons made with a clear point of view." },
      { q: "Is optimising for AI search different from normal SEO?", a: "Largely the same work rather than a separate budget. A well-structured, genuinely useful page that answers real questions directly is what earns a conventional ranking, a citation inside an AI Overview and a mention from an assistant." },
    ],
  },
  {
    slug: "google-ads-learning-phase",
    tag: "Paid",
    categories: ["Paid Media"],
    title: "Why does my first month of Google Ads look worse than month 4?",
    excerpt: "The first 30 days of a new ad account are a calibration period, not a verdict, and judging the campaign on them is the most expensive mistake a new advertiser makes.",
    author: "Click.n.likes team",
    readTime: "9 min read",
    date: "2026-08-14",
    body: `<p>In the past, a business that bought advertising bought a known quantity. A half-page in the trade journal ran on a fixed date, reached a circulation the publisher could quote, and cost exactly what the rate card said it cost. Nothing about that placement improved in its third week, because there was nothing in it capable of improving. Paid search operates on an entirely different principle, and it is the principle rather than the platform that catches most first-time advertisers off guard: a Google Ads campaign is not a placement you purchase, it is a system that has to learn your business before it can perform for it.</p>
      <p>This is why the first month so often reads as evidence that the whole exercise was a mistake. The spend is real and immediate, the enquiries are thin and erratic, and the cost per lead is a number nobody would sign off on twice. Month 4, in a well-managed account, frequently tells a completely different story with the same budget, the same offer and the same market. Understanding why that gap exists is the difference between switching a campaign off a fortnight before it would have started working and holding a considered position through the only phase that was ever going to look bad.</p>
      <h2>Why is the first month genuinely worse, rather than just a slow start?</h2>
      <p>Because the bidding system is still calibrating, and until it has calibrated it is spending your budget on hypotheses rather than on evidence. A new campaign begins with no history of which searches, devices, times of day, locations and audience signals actually produce enquiries for your specific business. It has category-level priors and nothing else. Every click it buys in that period is partly an experiment, and experiments include the ones that fail.</p>
      <p>This is not a defect and it is not something better account management can eliminate. It is the mechanism by which the platform becomes good at finding your buyers. The practical consequence is that early performance is not a weak version of eventual performance, it is a structurally different thing: unstable by design, and not yet predictive of anything. Google's own documentation is explicit that key metrics may vary during this window and advises against measuring performance until it has passed.</p>
      <h2>How long does the learning period actually last?</h2>
      <p>Longer than most advertisers are told, and it depends on your conversion volume rather than on the calendar. According to <a href="https://support.google.com/google-ads/answer/13020501" target="_blank" rel="noopener">Google Ads Help's documentation on the duration of the learning period</a>, calibration can take up to three weeks or one to two full conversion cycles, though it can resolve faster where there is plenty of conversion data. Google names three factors that determine which end of that range you land on:</p>
      <ul>
        <li><strong>The number of conversions your campaigns generate:</strong> A campaign producing a healthy volume of conversions gives the system evidence quickly. A low-volume account, which describes most small businesses and most high-value B2B services, supplies that evidence slowly, and the learning period stretches accordingly.</li>
        <li><strong>The length of your conversion cycle:</strong> The lag between the click and the conversion it eventually produces. A clinic booking taken the same afternoon calibrates far faster than an industrial enquiry that runs through a specification review and a procurement process before anyone counts it as a lead.</li>
        <li><strong>The bid strategy in use:</strong> Strategies optimising toward conversions or conversion value have more to work out than simpler ones, and take correspondingly longer to settle.</li>
      </ul>
      <p>Read those three together and an uncomfortable implication follows: the businesses most likely to be alarmed by a bad first month, the low-volume, long-cycle, high-value ones, are precisely the businesses whose learning period runs longest. Founders, practice managers and marketing leads in exactly those categories are the ones most often advised to give it two weeks, which is close to the worst possible amount of time to give it.</p>
      <h2>What does that early volatility look like in a real account?</h2>
      <p>It looks like flat months that resolve into a steep climb once the calibration finishes, provided nobody panics in between.</p>
      <p><strong>Example in Action:</strong> On our <a href="/work/aidbylaw/">13-month AidByLaw engagement</a>, a legal consultation platform running Google Search and Meta lead-generation campaigns on a monthly budget in the ₹50,000 to ₹1,50,000 range, the first two months were visibly rougher than everything that followed. Both platforms were working through their learning phases, delivery was inconsistent, and leads sat at 20 to 30 a month. Month 3 produced 60. Month 4 produced 150. Month 5 produced 200, and month 6 produced 300. The budget did not change shape to cause that; the campaigns finished learning. By the close of the retainer the paid channel was running at roughly ten times its early learning-phase volume, and even then the curve was not smooth, because a mid-engagement stretch dipped back to around 270 a month before further optimisation recovered it.</p>
      <p>The honest reading of that curve is not that paid search is magic after month 4. It is that a decision made on the month-1 number would have been made on the least informative data the account would ever produce.</p>
      <h2>What is the most expensive mistake businesses make in month 1?</h2>
      <p>Resetting the learning period, repeatedly, in an entirely well-intentioned attempt to fix the results. Significant changes to a campaign, its budget, its bid strategy or its conversion setup send the system back to recalibrate. An advertiser who reacts to a disappointing first fortnight by rewriting the bid strategy, then reacting to the next disappointing fortnight by rewriting it again, has not run a campaign for two months. They have run the first two weeks of a campaign four times, and paid for the privilege each time.</p>
      <p>This is the failure mode we see most often in accounts inherited from a previous agency or from a founder managing it personally: a change log full of activity, and a campaign that has never once been allowed to reach a stable state. The spend looks like a paid media programme. The data looks like four separate false starts.</p>
      <h2>Does that mean you should leave the campaign alone for 3 months?</h2>
      <p>No, and this is the distinction that matters most. Leaving a new campaign untouched is not patience, it is absence. The discipline is knowing which category of work resets calibration and which does not.</p>
      <ul>
        <li><strong>Work that does not disturb the learning period:</strong> Adding negative keywords to stop the budget paying for searches that were never going to convert, correcting mismatches between an ad's promise and its landing page, fixing broken or under-tracked conversion events, and improving the page the traffic actually arrives on.</li>
        <li><strong>Work that restarts it:</strong> Switching bid strategy, materially changing budgets, restructuring campaigns, and altering what counts as a conversion. These are sometimes necessary, but each one should be a deliberate decision with a reason attached, not a reflex to a bad week.</li>
      </ul>
      <p>The first list is where nearly all the genuine value of month 1 sits. A campaign's early period is not dead time to be endured; it is the window in which an operator earns their keep by cleaning up waste and strengthening the destination, without ever touching the dials that would send the system back to the beginning. That is what hands-on management of a live account actually means, and it is why <a href="/services/paid-campaigns/">paid campaigns</a> handled as a set-and-forget purchase reliably underperform ones that are worked.</p>
      <h2>Should the first month's cost-per-lead set your expectations for the year?</h2>
      <p>It should not, and treating it as a baseline distorts every decision that follows. An early cost per lead is inflated by the experimental spend the system needed in order to stop experimenting. Anchoring a year's forecasting, or a decision about whether the channel works at all, to that figure builds the whole plan on the single least representative number the account will produce.</p>
      <p>A more useful discipline is to set the expectation before launch rather than after. If you have already worked out <a href="/insights/paid-ads-budget/">how much to actually budget for Google Ads</a> from your target enquiry count, a realistic conversion rate and your industry's cost per click, you have a defensible figure to measure against once calibration finishes, and a reason not to panic before it does. The budget formula tells you what to spend; the learning period tells you when the resulting number becomes real.</p>
      <h2>Where does organic fit while the ad account is still learning?</h2>
      <p>It should already be running, because the learning period is precisely when a business is most exposed to having a single channel. A campaign in calibration is a channel that cannot yet be relied on, and a business with nothing else working is left with no enquiries and mounting spend at the exact moment its confidence is lowest. That combination is what usually kills a paid programme, rather than the campaign's own eventual performance.</p>
      <p>On the AidByLaw engagement the website rebuild and <a href="/services/seo/">SEO services</a> began in month 2, deliberately, so that organic was contributing real leads by the middle of the engagement rather than starting from zero at the end of it. Organic search compounds slowly and does not calibrate away; it is the channel that keeps producing after the ad budget stops. Running the two together is the standard we hold in every <a href="/">organic growth agency</a> engagement that includes a paid component, and it is what makes a difficult first month survivable rather than existential.</p>
    ...
    faqs: [
      ...
      { q: "Is it normal for the first month of Google Ads to lose money?", a: "Early performance is normally volatile and not yet representative, because the bidding system is still working out which searches, devices, locations and times of day actually produce enquiries for your business. Google's own documentation advises against measuring performance until the learning period has passed." },
      { q: "Will changing my bids or budget in the first month fix bad results?", a: "Usually the opposite. Significant changes to bid strategy, budget, campaign structure or conversion setup send the system back to recalibrate, so repeated adjustments can leave an account permanently restarting instead of ever stabilising." },
      { q: "What should I actually do during the Google Ads learning period?", a: "Work that does not reset calibration: adding negative keywords to cut wasted spend, fixing mismatches between the ad and its landing page, correcting conversion tracking, and improving the page traffic arrives on. Leave bid strategy and budget structure alone unless there is a deliberate reason to change them." },
      { q: "When should I judge whether Google Ads is working for my business?", a: "After calibration finishes, against a cost-per-lead target set before launch rather than one inferred from month 1. An early cost per lead is inflated by the experimental spend the system needed, so it is the least representative figure the account will produce." },
    ],
  },
  {
  ...
  },
  {
    ...
    tag: "Local SEO",
    categories: ["Local SEO"],
    title: "Service-area business vs. storefront: does local SEO work differently?",
    excerpt: "Plumbers, electricians and consultants who visit the customer play a different local SEO game than a clinic with a front door, and treating them the same costs both.",
    author: "Click.n.likes team",
    readTime: "9 min read",
    date: "2026-08-08",
    body: `<p>Before the internet, a plumber's reach was drawn by word of mouth: a satisfied customer told a neighbour, who told a neighbour, and the radius grew one referral at a time, with no fixed edge. Today that same radius is drawn explicitly, in a settings panel, the moment you set up a <a href="/services/local-seo/">Google Business Profile</a>. Get that one setting wrong and you are either invisible in the streets you actually serve, or claiming territory Google quietly distrusts you for.</p>
      <p>Most local SEO advice is written for a business with a front door: a clinic, a salon, a restaurant, somewhere a customer physically walks in. Plumbers, electricians, HVAC technicians, home cleaners, tutors and consultants who travel to the customer instead are told to follow the same playbook, and it does not fully fit. The underlying goals, trust and relevance, are identical. The mechanics of earning them are not.</p>
      <h2>What is a service-area business, and does Google treat it differently?</h2>
      <p>Yes, structurally. A storefront business has a fixed address the public can visit, and Google Business Profile is built around that address being real and searchable. A service-area business (SAB) instead lists the cities, postal codes or regions it travels to, and Google offers this as a distinct profile type precisely because the two work differently under the hood. Per Google's own Business Profile guidelines, a service-area business should not display a public address at all unless customers are actually welcomed there, a policy built on geographic honesty rather than convenience.</p>
      <p>Ignore that distinction and you get one of two failure modes: a home-based electrician who lists their residential address as if it were a shopfront, confusing both Google and any customer who takes the pin literally, or a business with a real office that hides its address out of habit and loses the storefront-specific ranking signals that address was earning it.</p>
      <h2>Should you hide your address if customers never visit you?</h2>
      <p>Yes, and this is the single most common mistake we find when we audit a service-area profile. If a plumber, a mobile groomer or an independent consultant does not receive customers at a fixed location, that address should not be public on the profile, even if the business technically has one for mail or storage. Set the listing to a service-area business, define the areas served, and let the profile do what it was built to do.</p>
      <p>The instinct to publish an address anyway usually comes from a fear of looking less established without one. In practice the opposite is closer to true: a profile that is honest about being a mobile or home-based operation, backed by real reviews naming real jobs completed in real neighbourhoods, reads as more credible than one straining to look like a storefront it is not.</p>
      <h2>How do you define your service area without hurting your ranking?</h2>
      <p>Narrower and truthful beats wide and aspirational. Google lets a service-area business list up to twenty areas, and the temptation is to claim every district within an hour's drive to maximise reach. That temptation is worth resisting: Google's own ranking signals for service-area businesses lean heavily on proximity and on-the-ground evidence, reviews, completed jobs, local mentions, drawn from the places you actually work. A business claiming twenty towns it visits once a year will trust-signal worse than one claiming the six it genuinely serves every week and can prove it with reviews from each.</p>
      <p>A practical test: if you could not point to at least one recent, real job in an area you have listed, that area probably should not be on the profile yet. Add it once you have the evidence, not before.</p>
      <h2>Do reviews work differently when there is no office to collect them in?</h2>
      <p>The mechanics change even though the goal, a steady, genuine cadence, does not. A clinic can hand a customer a QR code at the front desk on the way out. A service-area business has no front desk, so the ask has to travel with the technician instead:</p>
      <ul>
        <li><strong>Ask at the Job Site, Not by Email Later:</strong> The moment satisfaction is highest is the moment the work is finished and the customer is standing in front of you, not three days later in an inbox they may never open. A short text with a direct review link, sent from the van before you leave the driveway, converts at a far higher rate than a follow-up email.</li>
        <li><strong>Name the Job, Not Just the Rating:</strong> A review that mentions "same-day emergency call" or "re-wired the whole kitchen circuit" does keyword work no star rating can, because it is written in the exact phrases the next customer will search.</li>
        <li><strong>Give Every Technician the Same Script:</strong> If five technicians each ask differently, or some do not ask at all, your review volume becomes a function of who happened to show up rather than a system. One consistent script, given to everyone, is what turns review collection from a personality trait into infrastructure.</li>
      </ul>
      <p>The underlying discipline here, a real system rather than an occasional reminder, is the same one that separates the profiles that win the local pack from the ones that merely exist; see <a href="/insights/gbp-mistakes/">the Google Business Profile mistakes costing you the local pack</a> for the full list, most of which apply to a service-area profile exactly as written.</p>
      <h2>Example in Action: two electricians, one city</h2>
      <p><strong>Example in Action:</strong> picture two electricians serving the same metro area. The first lists all fourteen neighbouring towns as service areas the week they launch their profile, publishes their home address out of habit, and asks for reviews only when a customer happens to offer one. The second lists the four towns they actually work every week, hides their address as a genuine service-area business, and texts a review link from every completed job. Within a few months, the second profile carries far denser, more specific, more geographically clustered proof of real work, exactly what Google's proximity and relevance signals reward, while the first is spread thin across territory it cannot back up. Neither business changed what work they did; only the profile's honesty and cadence changed.</p>
      <h2>Should a service-area business still build pages for each area it serves?</h2>
      <p>Yes, and this matters more for a service-area business than for a storefront, not less, because the profile alone cannot carry the geographic proof on its own. A dedicated page per genuinely served area, naming the neighbourhood, the specific jobs done there, and a local phone number or contact path, gives both Google and the visitor the same evidence the profile is claiming: that you actually work here, not just that you are willing to drive here. It only pays off, however, if that page is fast and clear enough to hold a visitor's attention, which is a question of <a href="/insights/3-second-test/">whether your site passes the three-second test</a> the moment someone lands on it from a search.</p>
      <h2>How many service areas is too many?</h2>
      <p>There is no fixed ceiling, but the discipline is the same one that governs categories and claims everywhere on a Google Business Profile: list what you can prove, not what you wish were true. A service-area business that expands its territory should expand its evidence, reviews, completed jobs, local pages, at the same pace, area by area, rather than declaring twenty towns served on day one and hoping the reviews eventually catch up. Growth here compounds the way an <a href="/">organic growth agency</a> would want any channel to compound: deliberately, one proven area at a time, rather than in a single wide, unbacked claim.</p>
    ...
    faqs: [
      ...
      { q: "How many service areas should I list?", a: "Only the ones you can back up with real, recent work. A narrower list you can prove with reviews and completed jobs from each area outperforms a wide list claimed on day one with nothing behind it yet." },
      { q: "Do reviews matter more for a service-area business than a storefront?", a: "They matter equally, but the collection mechanics differ. Without a front desk moment, the ask has to travel with the technician, a text sent from the job site converts far better than a follow-up email days later." },
      { q: "Does a service-area business still need location pages on its website?", a: "Yes, arguably more than a storefront does, since the profile alone cannot carry all the geographic proof. A page per genuinely served area, naming real work done there, backs up what the profile is already claiming." },
      { q: "Can a business have both a storefront and a service area?", a: "Yes, this is common, a clinic with a front door that also makes home visits, for example. In that case the address stays public and the service-area settings are used alongside it, not instead of it." },
    ],
  },
  {
    ...
    body: `<p>A factory once proved its price was fair by letting a buyer walk the floor and see the machinery, the labour, the material. A website quote offers no such tour: two numbers can sit side by side on a spreadsheet with no way to tell, from the figure alone, which one is a fair price for a real build and which one is a number picked to win the deal and worry about delivery later. The only way to actually compare website quotes is to know two things: what a proper build costs in the real market, and exactly what should be included in that price rather than billed back to you afterward.</p>
      <p>Both of those are answerable with real numbers, not vague reassurance, so this is written as a reference you can hold a quote against, rather than <a href="/insights/cheap-website-cost/">why a good website costs more than a cheap quote</a>, which makes the case for why the gap exists in the first place.</p>
  ...
  },
  {
    ...
    body: `<p>A shopfront earns trust the moment it opens: a passer-by can see the fittings, the stock, the staff, and decide in seconds whether to walk in. A social media account earns trust on a slower, less visible clock, and a founder who expects a shopfront's instant read from a following that is only a few weeks old is measuring the wrong thing at the wrong time, then concluding the whole effort failed.</p>
      ...
      <p>None of these stages compound without a cadence the account can actually sustain past month six, which is exactly why <a href="/insights/social-every-day/">how often you should actually post on social media</a> matters more than any single month's numbers.</p>
  ...
  },
  {
    ...
    body: `<p>In the past, buying visibility meant buying a billboard or a page in the newspaper, a flat fee paid regardless of how many people actually acted on what they saw. Paid search inverted that arrangement entirely: you pay only when someone interested enough to click actually does, which sounds efficient right up until the moment you try to set a first-month budget and realise nobody gave you a number to start from.</p>
      <p>Most small businesses either guess, picking a round figure that feels safe, or copy whatever a competitor is rumoured to be spending. Both are the wrong inputs. A realistic Google Ads budget is not a feeling, it is arithmetic built from two things you can actually know: what a click costs in your industry, and what your own site does with the clicks it gets. This assumes paid is already the right call for where you are; if you have not settled <a href="/insights/seo-or-ads-first/">whether to invest in SEO or Google Ads first</a>, that decision comes before this budget does.</p>
  ...
  },
  {
    ...
    body: `<p>A factory once proved its worth through the machinery on its floor: heavier equipment, visibly, meant a more serious operation. A website offers no such visible tell. Two homepages can look almost identical in a screenshot, built from the same template, in the same color palette, and yet one converts visitors into enquiries while the other quietly leaks every visitor it earns. The difference rarely shows up in the price on the invoice, which is exactly why the cheap quote is so easy to accept and so expensive to live with.</p>
      ...
      <ul>
        ...
        <li><strong>Structure:</strong> A cheap build rarely accounts for the technical foundations, clean headings, valid schema markup, a logical URL structure, that search engines and AI systems actually read. The site can look complete while being functionally invisible to the systems that would otherwise send it customers for free. <a href="https://www.searchenginejournal.com/ranking-factors/core-web-vitals/" target="_blank" rel="noopener nofollow">Search Engine Journal's own analysis</a> notes that Core Web Vitals act as a tie-breaker between two pages of otherwise similar quality, so a technically weak build can lose rankings to a competitor it would otherwise match on content alone.</li>
      ...
      <p>Ask specifically what the quote includes for speed optimisation, schema markup, and mobile performance, not just "responsive design," which by now is table stakes rather than a differentiator. A quote that cannot answer those three questions specifically is a quote for a page that looks like a website, not one built to behave like a growth asset. It is also worth checking whether you would own the build outright or be locked into a proprietary platform that makes leaving expensive later. For the concrete included-versus-extra checklist to hold any quote against, plus real market pricing to compare it to, see <a href="/insights/website-cost-checklist/">what a website should actually cost and include</a>.</p>
  ...
  },
  {
    ...
    body: `<p>In the past, a shopkeeper's marketing budget was the cost of a signboard and, if business was good, a few lines in the local paper. There was no benchmark to check it against because there was barely a decision to make. A modern business does not have that luxury: a founder now has to decide, in advance and in cold rupees, how much of this year's revenue goes toward being found at all, and unlike the signboard, there is no single obviously correct number to copy.</p>
      ...
      <p>Put plainly: the smaller the business, the higher the percentage tends to run, not the lower. A founder who assumes marketing is a luxury to be trimmed once the business is "big enough" has the relationship backwards. <a href="https://blog.hubspot.com/marketing/marketing-budget-percentage" target="_blank" rel="noopener nofollow">HubSpot's own marketing-budget guidance</a> lands in the same range, breaking the figure down further by industry and company stage rather than treating it as one flat number.</p>
  ...
  },
  {
    ...
    body: `<p>For the better part of two decades, a clinic's growth travelled a predictable path: word of mouth in the waiting room, a visible board on the right road, and eventually, a hard-won position on the first page of Google. Those foundations remain valuable, but the path your next patient, client or buyer takes to find you has shifted once again, and this time the destination is not a list of links at all.</p>
      ...
      <p>The businesses most exposed are the ones whose buyers research carefully before they commit, because those are precisely the decisions people now delegate to an assistant. If your customers compare options, read reviews, or weigh specifications before they ever call, your absence from the AI's shortlist is quietly costing you the consideration you never knew you had lost. The gap is measurable, not theoretical: <a href="https://searchengineland.com/google-ai-overviews-drive-drop-organic-paid-ctr-464212" target="_blank" rel="noopener nofollow">Search Engine Land's reporting on Google's AI Overviews</a> found that brands cited inside an AI Overview earn roughly 35% more organic clicks and 91% more paid clicks than brands the same Overview leaves out.</p>
  ...
  },
  {
    ...
    body: `<p>Before the internet, the most valuable asset a local business could hold was a corner shopfront on a busy road: visibility was purchased in brick and rent. Today, that corner is the "local pack", the map with three businesses that Google presents for searches such as "dental clinic near me", and it is won or lost not with rent, but with the discipline of your <a href="/services/local-seo/">Google Business Profile</a>.</p>
      ...
      <p>For the exact script and timing that makes the ask itself work, without it reading as begging, see <a href="/insights/reviews-that-convert/">how to actually ask for more Google reviews</a>.</p>
  ...
  },
  {
    ...
    body: `<p>There was a time when publishing carried its own authority: owning the means of distribution was the achievement, and readers came to whoever held the press. Today anyone can publish in minutes, and the consequence is a web where the overwhelming majority of business blog posts attract no meaningful search traffic at all: <a href="https://ahrefs.com/blog/search-traffic-study/" target="_blank" rel="noopener nofollow">Ahrefs' analysis of roughly 1 billion pages</a> found that 96.55% of them get zero traffic from Google. The scarce resource is no longer publication; it is structure.</p>
      ...
      <p>Finding those questions is the real work, and it is the heart of a serious <a href="/services/content-marketing/">content marketing programme</a>. They come from your sales calls, your inbox, the "people also ask" boxes on Google, and the follow-up questions an AI assistant suggests. Keyword research tools like <a href="https://www.semrush.com/blog/category/seo/keyword-research/" target="_blank" rel="noopener nofollow">Semrush's keyword research resources</a> and Ahrefs' own tooling can surface the phrasing real buyers already search for, when your own sales conversations run dry. Each real question your buyers ask is a post that can earn traffic for years, because unlike a trend, a genuine question does not expire.</p>
