import{j as e}from"./jsx-runtime.D_zvdyIk.js";import{r as n}from"./index.DBy5LfQW.js";import{s as r,O as b}from"./engine.D-Tn5flh.js";function w({thankYouHref:d}){const[s,a]=n.useState(!1),[m,o]=n.useState(!1);async function c(i){i.preventDefault();const u=i.target,t=new FormData(u).get("email"),l=typeof window<"u"?window.location.pathname:"";if(a(!0),o(!1),!(await r({toEmail:b,replyTo:t||void 0,subject:`New blog-newsletter lead: ${t||"website visitor"}`,bodyText:`New submission from the blog-newsletter form:
