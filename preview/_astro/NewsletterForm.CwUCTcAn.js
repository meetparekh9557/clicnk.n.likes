import{j as t}from"./jsx-runtime.D_zvdyIk.js";import{r as m}from"./index.DBy5LfQW.js";import{s as i,O as d}from"./engine.CUwE93Op.js";function x({thankYouHref:l}){const[s,a]=m.useState(!1);function r(o){o.preventDefault();const n=o.target,e=new FormData(n).get("email");i({toEmail:d,replyTo:e||void 0,subject:`New blog-newsletter lead: ${e||"website visitor"}`,bodyText:`New submission from the blog-newsletter form:

email: ${e}`,fields:{form:"blog-newsletter",email:e}}),i({toEmail:e,subject:"We got your message: Click.n.likes",bodyText:`Hi ,
